...
const Card = ({ drinkData, onDelete, onUpdate, viewMore }) => {
    ...
    return (
        <div className="flex flex-col w-full lg:w-[calc((100vw-var(--admin-sidebar-width)-32px)/3-12px)] lg:min-w-[220px] h-[380px] rounded-lg shadow-xl border-[1px] hover:scale-[1.01] hover:shadow-2xl transition-transform">
            <Image 
                src={ image }
                alt={ name }
                width={ 200 }
