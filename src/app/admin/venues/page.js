        ...
        <Suspense fallback={ <Loading customStyle="size-full" /> }>
            ...
            <section className="flex flex-col gap-2 p-4 ">
                <div className="flex justify-between items-center p-1 rounded-lg">
                    ...
                    <Link href="/admin/addvenue" className="flex gap-2 bg-green-600/40 rounded-full px-2 py-1 hover:bg-green-400 transition-colors">
                        <Plus size={20} />
