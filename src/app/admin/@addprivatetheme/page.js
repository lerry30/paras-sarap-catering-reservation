    ...
    const handleSubmit = async (ev) => {
        ...
        if(Object.values(invalidFields).length === 0) {
            try {
                ...
                const createThemeResponse = await sendForm('/api/themes/private', form);
    ...
    return (
        <section className="flex flex-col gap-2 p-4">
            ...
            <div className="flex justify-between items-center p-1 rounded-lg">
                <h2 className="font-headings font-semibold">Add New Private Theme</h2>
            </div>
            <form onSubmit={ handleSubmit } className="flex gap-4 font-paragraphs">
                ...
                <div className="grow flex flex-col gap-4 py-6">
                    <div className="w-full">
                        ...
                        <input name="themename" onChange={(e) => setThemeName(e.target.value)} className="input w-full border border-neutral-500/40" placeholder="Add Private Theme Name" />
...
export default AddPrivateTheme;
