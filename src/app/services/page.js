            ...
            <section className="w-screen min-h-screen flex justify-center items-center">
                <div className="w-full flex flex-col px-page-x md:px-4 py-4 md:min-h-[calc(100vh-var(--nav-height)-32px)]">
                    ...
                    <div className="w-full flex justify-center gap-4 mt-4 flex-wrap">
                        ...
                        <Card name="Debut Service" image={ DebutImg } description="Celebrate your debut in style with our curated debutante services. From elegant venues to personalized themes and seamless coordination, let us make your debut an occasion to remember." link="/reserve?display=themes&service=debut&set=1"/>
                        <Card name="Kids Party Service" image={ KidsPartyImg } description="Create magical memories for your little ones with our vibrant kids party services. From exciting themes to engaging entertainment and delightful treats, let us bring joy and laughter to your child's special day." link="/reserve?display=themes&service=kidsparty&set=1"/>
                        <Card name="Private Party Service" image={ PrivatePartyImg } description="Host an unforgettable private party with our exclusive services. From intimate gatherings to lavish celebrations, our experienced team will tailor every detail to exceed your expectations and create lasting memories." link="/reserve?display=themes&service=privateparty&set=1"/>
                    </div>
                </div>
            </section>
        </main>
