        ...
        <div className="pt-[var(--nav-height)]">
            ...
            <main className="w-full py-4 px-page-x">
                ...
                <section className="w-full flex flex-col items-center gap-4 p-4 md:h-[calc(100vh-var(--nav-height)-32px)]">
                    ...
                    <p className="font-paragraphs text-center w-1/2">Paras Sarap Catering Services started in 2012 as a small business by Mrs. Glecy Reyes Serrano, offering Filipino and street foods. With a focus on quality and customer service, they quickly gained popularity, expanding to accept bulk orders and deliveries for special occasions. Recognized for their delicious food, they entered the catering industry, becoming a renowned name in General Tinio and nearby areas, including Baguio, Pangasinan, and Tarlac.</p>
                    <Link href="/about" className="rounded-sm border-[1px] border-neutral-600 p-2 mt-[70px]">Learn More</Link>
                </section>
